...
nothing to interrogate; what is installed is what is in git. **Leave alone everything the person
...
There is nothing special to do, and nothing to install first. `/grillwork-upgrade` is only a
shortcut that points back at this file; the update path above is the real mechanism, and it has
always been reachable the same way the original install was — **point the agent at this file and
say the repo already has Grillwork.** The shortcut's absence costs you one sentence of typing,
not a capability.
